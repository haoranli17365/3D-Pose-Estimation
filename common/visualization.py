...
def render_animation(keypoints, keypoints_metadata, poses, skeleton, fps, bitrate, azim, output, viewport,
    ...
    def update_video(i):
        ...
        print('{}/{}      '.format(i+1, limit), end='\r')

    anim = FuncAnimation(fig, update_video, frames=limit, interval=1000 / fps, repeat=False)
    
    
    if output.endswith('.mp4'):
        writer = animation.FFMpegWriter(fps=fps, bitrate=bitrate, metadata={})
